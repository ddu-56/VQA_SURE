    ...
    <div className="min-h-screen bg-gradient-main wave-container">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 relative z-10">
        ...
        <div className="glass-card rounded-3xl p-6 sm:p-8 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
          ...
          {/* Response Area */}
          {mode === "one-pass" ? (
            <ResponseDisplay content={responseContent} isLoading={isLoading} hasImage={!!image} />
          ) : (
            <section aria-labelledby="chat-heading">
              ...
              {image ? (
                ...
                <div className="rounded-2xl bg-white/40 border border-primary-100/30 p-10 text-center">
                  <div className="w-12 h-12 mx-auto mb-4 rounded-xl bg-gradient-to-br from-primary-100 to-accent-400/20 flex items-center justify-center">
                  ...
                  <p className="text-primary-800/60 font-medium">
                    Waiting for an image to analyze
                  </p>
                  <p className="text-primary-700/40 text-sm mt-1">
                    Upload an image above to start asking questions.
                  </p>
                </div>
              )}
            </section>
        ...
        <div className="mt-6 text-center animate-fade-in" style={{ animationDelay: "0.5s" }}>
          <div className="inline-flex items-center gap-2 text-xs text-primary-700/40">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            </svg>
            <span>
              Images are processed in-memory and sent to Google Gemini for analysis. Nothing is stored on our servers.
            </span>
          </div>
        </div>
      </main>
